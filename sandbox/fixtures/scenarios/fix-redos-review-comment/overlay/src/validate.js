...
// Added for the upcoming bulk-import path (not yet wired up). Flagged in
// CODE_REVIEW.md — see that file before touching this.
const SAFE_WORDY_TITLE = /^([a-zA-Z]+\s?)*$/;

export function looksLikePlainText(title) {
  return SAFE_WORDY_TITLE.test(title);
}
